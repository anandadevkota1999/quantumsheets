...
use crate::formula::ast::Formula;   // Updated import
...
impl QuantumGrid {
    ...
    pub fn set_formula_natural(&mut self, reference: &str, natural_text: &str) -> Result<(), String> {
    ...
    pub fn print_stats(&self) {
        ...
        for (col_idx, column) in &self.columns {
            ...
            println!("   Column {}: {} cells, sum={:.1}", 
                     col_name, column.count(), column.sum());
        }
